...
const BASE_PITCH =
  "Somos a ROTA Atacado: reunimos pecas das fabricas do Polo de Confeccoes do Agreste pernambucano e vendemos no atacado para lojistas.";
...
- Marca: ROTA Atacado ("Moda que conecta negocios"). Liga as fabricas do Polo de Confeccoes do Agreste pernambucano (Toritama, Caruaru, Santa Cruz do Capibaribe, Riacho das Almas) a lojas de todo o Brasil.
- Pecas de VARIAS FABRICAS do polo num pedido e num atendimento so, com preco de atacado do polo.
- Forte em JEANS masculino e feminino, e moda em geral (do basico ao mais elaborado).
- O lojista monta o pedido na vitrine online (grade por tamanho e cor) e fecha pelo WhatsApp.
- Pedido minimo acessivel, contado por modelo (cada peca mostra o seu na vitrine) — atende loja pequena tambem.
...
- Deixe claro logo no inicio que as pecas vem das fabricas do polo do Agreste, com preco de atacado.
- Mencione 1 vantagem concreta (uma so): varias fabricas num pedido so, OU pedido minimo acessivel, OU pronta-entrega.
- Termine com 1 CTA leve. Ex.: "Posso te mandar a nossa vitrine?" / "Tem interesse em ver as pecas?" / "Quer que eu mande algumas fotos?".
...
- Termine assinando "— ROTA Atacado".
